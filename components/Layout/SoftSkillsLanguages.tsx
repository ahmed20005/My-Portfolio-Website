...
export const SoftSkillsLanguages: React.FC = () => {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      >
        <Card title="Soft Skills" className="h-full">
      ...
      >
        <Card title="Languages" className="flex flex-col justify-center h-full">
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-lg bg-zinc-50 border border-zinc-100 gap-2 sm:gap-4">
              <div className="flex items-center gap-3">
                <LangIcon className="w-5 h-5 text-zinc-400" />
                <span className="font-medium text-primary">Arabic</span>
              </div>
              <span className="text-sm text-secondary">Native Speaker</span>
            </div>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-lg bg-zinc-50 border border-zinc-100 gap-2 sm:gap-4">
              <div className="flex items-center gap-3">
                <LangIcon className="w-5 h-5 text-zinc-400" />
              ...
              <span className="text-sm text-secondary">Fluent (Reading/Writing)</span>
            </div>
          </div>
        </Card>
      </motion.div>
