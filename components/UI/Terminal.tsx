...
export const Terminal: React.FC = () => {
  ...
  return (
    <div className="w-full rounded-xl overflow-hidden border border-white/10 bg-[#0c0c0e] shadow-2xl shadow-black/20 font-mono text-sm md:text-base h-full flex flex-col ring-1 ring-white/5">
      {/* Terminal Header */}
